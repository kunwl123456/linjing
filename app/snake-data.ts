...
export const clinicalChecks: Record<Snake["venomClass"], ClinicalCheck[]> = {
  hemo: [
    { label: "血常规", tests: "血红蛋白/红细胞压积、血小板、白细胞", meaning: "血红蛋白下降可提示出血或溶血；血小板下降支持消耗性凝血异常，白细胞变化仅作综合判断。" },
    { label: "凝血功能", tests: "PT/INR、APTT、纤维蛋白原、FDP或D-二聚体", meaning: "凝血时间延长、纤维蛋白原下降及降解产物升高可提示蛇毒诱发的消耗性凝血病，应由医院动态复查。" },
    { label: "肾脏与尿液", tests: "肌酐、尿素氮、电解质、尿常规、尿量", meaning: "肌酐或钾升高、血尿/蛋白尿、少尿等可能提示急性肾损伤、溶血或肌肉损伤。" },
    { label: "床旁观察", tests: "血压、心率、出血点、肿胀范围与肢端循环", meaning: "低血压、异常出血、肿胀持续跨关节扩大或肢端灌注变差都属于需要升级处置的信号。" },
  ],
  neuro: [
    { label: "呼吸监测", tests: "呼吸频率、血氧、血气分析、肺活量或床旁通气能力", meaning: "神经毒可逐渐造成通气不足；血氧正常也不能单独排除早期呼吸肌无力，需连续观察呼吸趋势。" },
    { label: "神经查体", tests: "眼睑与眼球运动、发声吞咽、颈肌和四肢肌力", meaning: "眼睑下垂、复视、声音含糊、吞咽困难或肌力继续下降提示神经肌肉麻痹进展。" },
    { label: "基础验血", tests: "血常规、电解质、血糖、肝肾功能", meaning: "部分神经毒蛇咬伤的常规验血可接近正常；钠、钾等异常会影响神经和呼吸功能判断。" },
    { label: "循环观察", tests: "心率、血压、心电图、意识状态", meaning: "用于识别心律失常、循环不稳和缺氧。出现呼吸费力、嗜睡或发绀时不能等待化验结果。" },
  ],
  mixed: [
    { label: "呼吸与神经", tests: "呼吸频率、血氧、血气、眼睑/吞咽/肌力", meaning: "用于发现神经肌肉麻痹和通气不足；单次血氧正常不能代替持续临床观察。" },
    { label: "血液与生化", tests: "血常规、电解质、肝肾功能、肌酸激酶", meaning: "用于评估出血、炎症、肌肉和器官损伤；具体组合应根据蛇种及症状由医院决定。" },
    { label: "伤口与组织", tests: "肿胀边界、皮肤颜色、水疱/坏死、疼痛与肢端循环", meaning: "细胞毒造成的组织损伤可能继续进展，需要重复测量和外科评估，不能自行切开处理。" },
    { label: "必要时加查", tests: "凝血功能、尿常规、心电图及影像检查", meaning: "若有异常出血、深部肿胀、胸闷或循环不稳，医院会按表现补充检查。" },
  ],
  myo: [
    { label: "肌肉损伤", tests: "肌酸激酶CK、肌红蛋白、AST、LDH", meaning: "持续升高支持横纹肌损伤；数值需结合肌痛、无力和尿色变化连续判断。" },
    { label: "肾脏与尿液", tests: "肌酐、尿素氮、尿量、尿常规/尿肌红蛋白", meaning: "茶色尿、少尿或肌酐升高可提示肌红蛋白尿和急性肾损伤。" },
    { label: "电解质与心脏", tests: "血钾、钠、钙、酸碱状态、心电图", meaning: "横纹肌溶解可导致高钾血症和心律失常，严重异常需要紧急处理。" },
    { label: "呼吸监测", tests: "呼吸频率、血氧、血气与肌力", meaning: "部分海蛇毒兼有神经毒作用；呼吸无力时不能只根据肌酶结果等待观察。" },
  ],
  rear: [
    { label: "血常规", tests: "血红蛋白、红细胞压积、血小板", meaning: "用于发现失血、贫血和血小板消耗；早期正常并不保证之后不会出现异常。" },
    { label: "凝血功能", tests: "PT/INR、APTT、纤维蛋白原、FDP或D-二聚体", meaning: "部分后沟牙蛇咬伤可能出现延迟性凝血障碍，需要根据医嘱重复检测。" },
    { label: "肾脏与尿液", tests: "肌酐、尿素氮、电解质、尿常规、尿量", meaning: "用于识别异常出血、低灌注或血红蛋白尿相关的肾损伤。" },
    { label: "临床出血", tests: "牙龈/鼻腔出血、瘀斑、血尿、便血与血压", meaning: "任何自发性出血、头痛呕吐或循环不稳都应立即告知医护人员。" },
  ],
  none: [
    { label: "伤口评估", tests: "创口深度、异物、肌腱神经血管功能、持续出血", meaning: "无毒不等于无伤；深穿刺伤、大型蛇咬伤或活动受限时可能需要清创、缝合或影像检查。" },
    { label: "感染观察", tests: "红肿热痛、渗液、体温；必要时血常规与炎症指标", meaning: "这些验血通常只在怀疑感染或全身反应时选择，不能仅凭白细胞轻度升高判断感染。" },
    { label: "预防项目", tests: "破伤风免疫史、伤口污染情况", meaning: "由医护人员评估是否需要破伤风疫苗或被动免疫制剂，并给予规范伤口处理。" },
    { label: "升级就医", tests: "肿胀扩大、持续出血、剧痛、麻木无力或蛇种不明", meaning: "一旦出现这些情况，应按疑似毒蛇咬伤重新评估，而不是继续居家观察。" },
  ],
};
