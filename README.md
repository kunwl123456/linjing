...
下面三个例子分别代表神经毒蛇、血液/细胞毒蛇和无毒蛇。实际网站中的每个档案都采用类似结构，把“长什么样、哪里可能出现、咬伤后看什么”放在一起展示。

### 示例一：银环蛇——伤口不明显，也可能非常危险

<img src="public/snakes/bungarus-multi-1.webp" alt="银环蛇蓝黑色身体与规则窄白环" width="520" />

| 档案项目 | 内容 |
|---|---|
| 基本信息 | **银环蛇**（*Bungarus multicinctus*），眼镜蛇科，高危毒蛇；以夜间活动为主。 |
| 毒性类型 | **强神经毒**。突触前、突触后神经毒素可阻断神经与肌肉之间的信号传递。 |
| 当前收录分布 | 安徽、浙江、江西、福建、湖北、湖南、广东、广西、海南、贵州、云南、四川。省级索引不代表完整调查结果。 |
| 外观 | 身体多为黑色或蓝黑色，表面光亮，通常有数量较多的窄白环；黑环明显宽于白环，头颈分界不明显。 |
| 重要区别 | 背中线一列鳞片明显扩大，身体横切面近三角形。幼年眼镜蛇的浅色横纹通常更不规则、头颈更宽；部分白环蛇的浅带可能中断。但现场看不清时，黑白环纹蛇一律不要接触。 |
| 中毒表现 | 伤口早期可能只有轻微麻木，甚至不痛不肿；之后可出现眼睑下垂、复视、声音嘶哑、吞咽困难和全身无力，严重时呼吸肌麻痹。 |
| 医院可能监测 | 呼吸频率、血氧、血气、通气能力；眼球运动、吞咽和四肢肌力；血常规、电解质、肝肾功能以及心电图。 |
| 安全提示 | “伤口不疼”不能排除中毒。任何疑似咬伤都应减少活动并立即就医，不能等待症状变明显。 |

图片：camellia_l，海南东方，2025-07-05，CC BY 4.0；[查看 iNaturalist 原始观察](https://www.inaturalist.org/observations/322440222)。

### 示例二：尖吻蝮——肿胀、出血与组织损伤需要持续观察

<img src="public/snakes/deinagkistrodon-1.webp" alt="尖吻蝮粗壮身体、上翘吻端和三角背斑" width="520" />

| 档案项目 | 内容 |
|---|---|
| 基本信息 | **尖吻蝮**（*Deinagkistrodon acutus*），蝰科，高危毒蛇；民间也常称“五步蛇”。 |
| 毒性类型 | **血液毒、凝血毒与细胞毒**。主要影响凝血系统和血管，并造成明显的局部组织损伤。 |
| 当前收录分布 | 安徽、浙江、江西、福建、湖北、湖南、广东、广西、重庆、四川、贵州。 |
| 外观 | 体形粗壮，头部宽大，吻端明显上翘；棕褐色背面常有左右相接的深色三角斑，形成沙漏形或近似 X 形花纹。 |
| 重要区别 | 上翘吻端与成对三角背斑组合较有代表性，但仍可能与原矛头蝮等褐色蝰蛇混淆。“三角头”不能单独作为判断依据，许多无毒蛇受惊时也会压宽头部。 |
| 中毒表现 | 伤口常明显疼痛并持续肿胀，可能出现瘀斑、血疱、渗血和组织坏死；严重时可发生牙龈出血、血尿、休克、少尿或急性肾损伤。 |
| 医院可能监测 | 血红蛋白、血小板；PT/INR、APTT、纤维蛋白原、D-二聚体；肌酐、电解质、尿常规和尿量，并连续标记肿胀范围及观察肢端循环。 |
| 安全提示 | “五步蛇”只是俗名，不表示被咬后只能走五步，也不能用行走距离判断严重程度。不要切开、吸吮或自行绑扎伤口。 |

图片：camellia_l，浙江杭州，2025-06-26，CC BY 4.0；[查看 iNaturalist 原始观察](https://www.inaturalist.org/observations/322433736)。

### 示例三：王锦蛇——无毒不等于可以徒手抓

<img src="public/snakes/elaphe-carinata-1.webp" alt="王锦蛇粗壮身体、起棱鳞片和深色网纹" width="520" />

| 档案项目 | 内容 |
|---|---|
| 基本信息 | **王锦蛇**（*Elaphe carinata*），游蛇科，大型无毒蛇。 |
| 毒性类型 | **无蛇毒注入**，不会造成典型的神经、凝血或肌肉蛇毒中毒综合征。 |
| 当前收录分布 | 河南、江苏、安徽、浙江、江西、福建、湖北、湖南、广东、广西、重庆、四川、贵州、云南、陕西。 |
| 外观 | 身体大型粗壮，背面可为黄褐、橄榄褐至黑褐色；鳞片边缘较深，形成网纹，体后段和尾部常见黄黑相间斜纹。 |
| 重要区别 | 起棱鳞片、粗壮体形和网纹感较明显，可能被误认为眼镜王蛇或大型蝰蛇。不要因为网页判断“无毒”就靠近验证。 |
| 咬伤表现 | 可能造成多排牙痕、疼痛、出血、肿胀和软组织损伤；大型个体咬合可形成较深创口。 |
| 医院可能评估 | 创口深度、异物、肌腱和神经血管功能；必要时检查感染指标，并评估破伤风免疫情况。 |
| 安全提示 | 它受逼迫时可能连续咬击。发现后留出退路，不围堵、不触摸，确需移除时联系消防或当地野生动物救助人员。 |

图片：angryphyco，福建宁德，2022-09-03，CC BY 4.0；[查看 iNaturalist 原始观察](https://www.inaturalist.org/observations/310452858)。
